...
SELECT * FROM tb_produtos WHERE categoria_id = 2 ORDER BY nome;
...
SELECT * FROM tb_produtos WHERE nome LIKE "%ra";
SELECT * FROM tb_produtos WHERE nome LIKE "r%a";
SELECT * FROM tb_produtos WHERE preco LIKE "1%";

SELECT count(*) FROM tb_produtos;
SELECT count(categoria_id) FROM tb_produtos;
SELECT sum(preco) AS Soma FROM tb_produtos;
SELECT format(avg(preco), 2) AS Média FROM tb_produtos; -- formatar casas
SELECT format(round(avg(preco)), 2) AS Média FROM tb_produtos; -- arredondar para cima*/
SELECT format(ceil(avg(preco)), 2) AS Média FROM tb_produtos; -- rredondar para baixo

SELECT categoria_id, format(avg(preco), 2) AS Média FROM tb_produtos GROUP BY categoria_id;

SELECT nome, min(preco) AS Menor FROM tb_produtos;
SELECT nome, max(preco) AS Maior FROM tb_produtos;
